...
const Footer = () => {
    return (
        <div className=''>
            <footer className="footer grid-rows-2 p-10 pl-20 bg-neutral text-neutral-content">
                <div>
                ...
                <div>
                    <span className="footer-title">Social</span>
                    <a href="https://www.twitter.com/arnob_tarafder" className="link link-hover">Twitter</a>
                    <a href="https://www.instagram.com/arnob_tarafder/" className="link link-hover">Instagram</a>
                    <a href="https://www.facebook.com/mr.tarafder/" className="link link-hover">Facebook</a>
                    <a href="https://www.github.com/arnobtarafder" className="link link-hover">Github</a>
                </div>
                <div>
            ...
            <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                <div className="items-center grid-flow-col">
                    ...
                    <p>Air Cruise Ltd. <br />Providing reliable tech since 1992</p>
                </div>
                <div>
                    <p className='justify-center align-items-center'>Copyright © 2022 - All right reserved by Air Cruise Ltd</p>
                </div>
